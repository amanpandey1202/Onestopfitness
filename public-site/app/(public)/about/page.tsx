  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        ...
        />
        <Reveal className="mx-auto mt-8 max-w-3xl space-y-4 text-center text-white/65">
          <p>
      ...
      {founder && (
        <section className="border-y border-white/10 bg-gym-ink">
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 lg:grid-cols-2">
            <Reveal variant="zoom" delay={0} className="relative mx-auto aspect-square w-full max-w-sm overflow-hidden rounded-2xl border border-gym-lime/40 shadow-glow">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {team.map((trainer, i) => (
              <Reveal key={trainer.id} delay={i * 90} className="h-full">
                <div className="h-full rounded-2xl border border-white/10 bg-gym-ink p-6 text-center shadow-card transition hover:-translate-y-1 hover:border-gym-lime/60 active:scale-[0.98]">
