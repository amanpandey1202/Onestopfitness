        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="panel p-7">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl border border-gym-lime/30 bg-gym-lime/10 text-gym-lime">
        ...
        <div className="section mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {groupClasses.map((cls) => (
              <div key={cls} className="panel p-6 text-center">
      ...
      <section className="section mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {personalTrainingAreas.map((area) => (
            <div
              key={area}
              className="check-row rounded-xl border border-white/10 bg-[#0e0e0e] px-5 py-4"
            >
